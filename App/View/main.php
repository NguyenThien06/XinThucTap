				...
				<div class="row">
						...
						<div class="p-l-25 p-r-30 p-lr-0-lg">
							<div class="wrap-slick3 flex-sb flex-w">
								...
								<div class="slick3 gallery-lb">
									<div class="item-slick3" id="data_thumb" data-thumb="/template/images/product-detail-01.jpg">
										<div class="wrap-pic-w pos-relative">
											<img src="/template/images/product-detail-01.jpg" id="detail_img" alt="IMG-PRODUCT">

											<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" 
											  id="href_img" href="/template/images/product-detail-01.jpg">
					...
					<div class="col-md-6 col-lg-5 p-b-30">
						<div class="p-r-50 p-t-5 p-lr-0-lg">
							<h4 id="detail_h4" class="mtext-105 cl2 js-name-detail p-b-14">
								Lightweight Jacket
							</h4>

							<span id="detail_price" class="mtext-106 cl2">
								$58.79
							</span>

							<p id="detail_description" class="stext-102 cl3 p-t-23">
